...
public class TimeHelper {
	public static String toTimeString(long time) {
		TimeHelper t = new TimeHelper(time);
		int day = t.get(TimeHelper.DAY);
		int hour = t.get(TimeHelper.HOUR);
		int minute = t.get(TimeHelper.MINUTE);
		int second = t.get(TimeHelper.SECOND);
...
//          Long milliSecond = ms - day * dd - hour * hh - minute * mi - second * ss;
     ...
     * @param second    秒
     */
    public TimeHelper(int hour, int minute, int second) {
...
//    	System.out.println(time);
     ...
     * @param second    秒
     */
    public TimeHelper(int day, int hour, int minute, int second) {
     ...
     * @param time      字符串格式的时间
     */
    public TimeHelper(String time, String timeSeparator) {
     ...
     * @return          运算后的时间
     */
    public TimeHelper addTime(TimeHelper time) {
    	TimeHelper result = new TimeHelper();
        int up = 0;     // 进位标志
     ...
     * @return          运算后的时间
     */
    public TimeHelper subtractTime(TimeHelper time) {
    	TimeHelper result = new TimeHelper();
        int down = 0;       // 退位标志
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final TimeHelper other = (TimeHelper) obj;
