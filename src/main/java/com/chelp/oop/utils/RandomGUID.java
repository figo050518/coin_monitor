...
public class RandomGUID extends Object{
	...
	public static void main(String args[]) throws Exception{
		...
		ResourceBundle bundle = ResourceBundle.getBundle("imgs_url");  
		String d = bundle.getString("SRC");
		String fileDir = d+"Band/"+df1.format(date); 
		...
		for (int i = 0; i < 1000; i++)
		{
			...
			System.out.println(myGUID.toString());
			// System.out.println(myGUID.toString().replaceAll("-", ""));
